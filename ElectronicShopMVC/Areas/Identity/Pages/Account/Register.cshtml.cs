...
namespace ElectronicShopMVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Xác nhận email của bạn",
                        $"Vui lòng xác nhận tài khoản của bạn <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>CLick vào đây</a>.");
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("Giao diện mặc định yêu cầu một kho lưu trữ người dùng có hỗ trợ email.");
            }
